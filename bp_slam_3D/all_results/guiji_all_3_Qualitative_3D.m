...
grid on;
grid on;
legend("gt","Ours\_3-2-2","Ours\_3-3-3","Ours\_3-3-4","Qua\_3-2-2","Qua\_3-3-3","Qua\_3-3-4",'Location', 'best');


saveas(gcf, './mgbsm_qua_guiji_3_3.jpg');
savefig('./mgbsm_qua_guiji_3_3.fig');
